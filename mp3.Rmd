...
## Leaflet Map
After the data manipulation, we created an interacting leaflet map that shows every MacLeish trail colored by its difficulty. We first created a color palette.
