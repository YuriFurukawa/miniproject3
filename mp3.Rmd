...
Smith College can put a sign at the intersection of Poplar Hill road and entry trail that suggests to turn right and take a break in Whately Met Observatory & Tower, Bechtel Environmental Classroom, Orchard Met, and Trail Kiosk. There are 4 landmarks around entry trail. In addition to that, entry trail is classified as a easy road. Therefore, people can enjoy that area who want to take a break while they are biking. 
